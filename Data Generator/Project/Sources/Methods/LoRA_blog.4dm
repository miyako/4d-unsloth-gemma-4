...
$out:=$root.folder("blog_posts_jsonl")
$out.create()
var $folders : Collection
var $folder : 4D:C1709.Folder
var $file : 4D:C1709.File
$folder:=$root.folder("blog_posts")
var $version : Text
For each ($file; $folder.files(fk ignore invisible:K87:22 | fk recursive:K87:7).query("extension == :1"; ".txt"))
	$task:={file: $file; \
