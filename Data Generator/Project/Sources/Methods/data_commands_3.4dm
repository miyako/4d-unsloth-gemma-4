...
Else 
	...
	If (This:C1470=Null:C1517)
		...
		$agent:=cs:C1710._AgentRemoteText.new("Azure_xAI"; "grok-4-1-fast-reasoning")
		//$agent:=cs._AgentRemoteText.new("Azure_xAI"; "Kimi-K2.6-1")
		//$agent:=cs._AgentRemoteText.new("Azure_xAI"; "grok-4-20-reasoning")
