...
$target_folder:=Folder:C1567(fk data folder:K87:12).folder("examples/blog_2")
...
Else 
	...
	//$agent:=cs._AgentRemote.new("Cohere"; "command-a-03-2025")
	...
	$file:=$folder.files(fk ignore invisible:K87:22).last()
	...
	$agent.startConversation($messages; Formula:C1597(data_blog_4))
